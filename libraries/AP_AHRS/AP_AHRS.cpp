...
void AP_AHRS_NavEKF3::get_results(Estimates &results)
{
            ...
            results.attitude_is_valid = _ekf3_started;
...
#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        ret = EKF3.wind_estimate(wind_vel);
        break;
#endif
...
bool AP_AHRS::get_secondary_attitude(Vector3f &eulers) const
{
    ...
    case EKFType::NONE:
        ...
        return dcm_estimates.attitude_is_valid;
    ...
    case EKFType::THREE:
        ...
        return ekf3_estimates.attitude_is_valid;
#endif
    ...
    case EKFType::EXTERNAL: {
        ...
        return external_estimates.attitude_is_valid;
    }
#endif
    }
...
bool AP_AHRS::get_secondary_position(Location &loc) const
{
    ...
    case EKFType::THREE:
        // EKF3 is secondary
        return EKF3.get_secondary_location(loc);
#endif
...
#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE: {
        bool ret = EKF3.started() && EKF3.healthy();
        if (!ret) {
            return false;
        }
        if ((_vehicle_class == VehicleClass::FIXED_WING ||
...
#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        imu_idx = EKF3.get_primary_IMU_index();
...
bool AP_AHRS::get_vel_innovations_and_variances_for_source(uint8_t source, Vector3f &innovations, Vector3f &variances) const
{
    ...
    case EKFType::THREE:
        // use EKF to get variance
        return EKF3.get_vel_innovations_and_variances_for_source((AP_NavEKF_Source::SourceXY)source, innovations, variances);
#endif
...
uint8_t AP_AHRS::get_primary_IMU_index() const
{
    ...
    case EKFType::THREE:
        // let EKF2 choose primary IMU
        imu = EKF3.get_primary_IMU_index();
        break;
#endif
#if AP_AHRS_SIM_ENABLED
    case EKFType::SIM:
