...
BWFD: AP_ADVANCEDFAILSAFE_ENABLED OK
BWFD: Successes: ['MOUNT', 'AUTOTUNE_ENABLED', 'AC_FENCE', 'CAMERA', 'RANGEFINDER_ENABLED', 'PROXIMITY_ENABLED', 'AC_RALLY', 'AC_AVOID_ENABLED', 'PARACHUTE', 'NAV_GUIDED', 'OPTFLOW', 'VISUAL_ODOMETRY_ENABLED', 'ADSB_ENABLED', 'PRECISION_LANDING', 'SPRAYER', 'WINCH_ENABLED', 'AP_ADVANCEDFAILSAFE_ENABLED']
...
specs = [
    {
        ...
        "reverse-deps": {
            ...
            "MODE_AUTO_ENABLED": ["MODE_GUIDED", "AP_ADVANCEDFAILSAFE_ENABLED"],
